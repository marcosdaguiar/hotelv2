...
const BookingSettings = () => {
  const [settings, setSettings] = useState({
    roomAvailability: { enabled: false, value: '' },
    minimumStay: { enabled: false, value: '' },
    channelIntegration: { enabled: false, value: '' },
    cancellationPolicies: { enabled: false, value: '' },
    noShowRules: { enabled: false, value: '' },
  });
