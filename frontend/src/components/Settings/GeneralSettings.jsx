...
const GeneralSettings = () => {
  const [settings, setSettings] = useState({
    ...
    timeZone: { enabled: false, value: '' },
    dateFormat: { enabled: false, value: '' },
    language: { enabled: false, value: '' },
    branding: { enabled: false, value: '' },
    contactInfo: { enabled: false, value: '' },
    operatingHours: { enabled: false, value: '' },
  });
