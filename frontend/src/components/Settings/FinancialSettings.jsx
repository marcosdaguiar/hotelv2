...
const FinancialSettings = () => {
  const [settings, setSettings] = useState({
    taxes: { enabled: false, value: '' },
    bookingFees: { enabled: false, value: '' },
    paymentGateways: { enabled: false, value: '' },
    refundPolicies: { enabled: false, value: '' },
    discounts: { enabled: false, value: '' },
    depositRequirements: { enabled: false, value: '' },
  });
